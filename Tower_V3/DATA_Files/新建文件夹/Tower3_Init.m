...
Ndata  =[{1  0 +0.0 11} {'Cir1001_S1_T0003'}; %POLE(Common node: Tower_Pole)    
         {2  0 -0.4 10} {'Cir3001_A1_T0003'}; %H1_PA1 (Common node: 10kV_A1)
         {3  0 +0.1 10} {'Cir3001_B1_T0003'}; %H1_PB1 (Common node: 10kV_B1)
         {4  0 +0.6 10} {'Cir3001_C1_T0003'}; %H1_PB1 (Common node: 10kV_C1)
...
data={'Tower No. 3' 1  1 0 [1020 0] 0 0 1};
