...
class McData(GlbInit):
    ...
    stroke_posi= {
        ...
        'TP_XY_1':,         # 数据类型为float  attachment position (x)
        'TP_XY_2':,         # 数据类型为float  attachment position (y)
        'SP_XY_1':,         # 数据类型为float  stroke position (x)
        'SP_XY_2':,         # 数据类型为float  stroke position (y)
    }
...
class LgtSource(MCData):
    ...
    lgt_soc = {
        ...
        'Waveform':,       # int (0/1/2/3) -1=input; 0=MC table; 1=8/20us; 2=2.6/50us; 3=10/350us; 4=..
    ...
    lgt_chan = {
        ...
        'H0':,      # 数据类型为float channel height
        'dH':,      # 数据类型为float increment of channel
        'Nc':,      # 数据类型为int number of segments
        'pos':,     # pos的数据类型np.array(float x 2) [x,y]
        'curr':,    # curr的数据类型np.array(float x N) current data
        'flag':,    # 数据类型为int
    }
